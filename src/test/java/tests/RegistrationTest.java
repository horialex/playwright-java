...
// @Test
// @Description("Verify that a new user can successfully register with valid
// credentials")
// @Order(1)
...
// browserConfig().getPage().screenshot(new
// com.microsoft.playwright.Page.ScreenshotOptions()
// .setPath(Paths.get(ProjectConstants.SCREENSHOT_PATH +
// "NewUserCreated.png")));
// homePage.signOut();
...
// com.microsoft.playwright.Page.ScreenshotOptions()
// .setPath(Paths.get(
// ProjectConstants.SCREENSHOT_PATH + "ExistingUserReauthenticated.png")));
...
// @Test
// @Description("Verify a previously saved context can be used for
// authentication.")
// @Order(2)
// public void UseExistingContext() {
// // Create a new context with the saved storage state
// BrowserContext newContext = browserConfig.getBrowser().newContext(
// new
// Browser.NewContextOptions().setStorageStatePath(Paths.get("LoginState.json")));
